    ...
    const data = [
        {
            ...
            imageUrl: '/media/2023/08/Community-e1539922397469.webp',
        },
        {
            title: 'Stakeholders',
            ...
            imageUrl: '/media/2023/09/Stakeholders.webp',
        },
        {
            title: 'Local & Global',
            ...
            <div className="container">
                <section>
                    <div className="relative text-center py-8">
                        <img src="/media/2023/09/Who-We-Serve-Cover-2.webp" alt="Who We Serve Cover" />
