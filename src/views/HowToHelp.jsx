...
export default function HowToHelp() {
  ...
  const volunteerPlatforms = [
    ...
    image: "/wp-content/uploads/2018/11/hhp-blueTM-2.png",
  ...
  const supporters = [
    ...
    { name: "ChildLife", logo: "/wp-content/uploads/2023/09/supporter_childlife_logo-400x124.webp" },
    { name: "Gerald Herman", logo: "" },
    { name: "Google", logo: "/wp-content/uploads/2023/09/supporter_2000px-Google_logo-400x135.webp" },
    { name: "Microsoft", logo: "/wp-content/uploads/2023/09/supporter_Microsoft_logo-400x85.webp" },
    { name: "Salesforce", logo: "/wp-content/uploads/2023/09/supporter_salesforce_logo.webp" },
    { name: "Notion", logo: "/wp-content/uploads/2023/09/supporter_notion_logo-400x400.webp" },
    { name: "Amazon", logo: "/wp-content/uploads/2023/09/supporter_Amazon_logo-400x121.webp" },
    { name: "WordPress", logo: "/wp-content/uploads/2023/09/supporter_WordPress_logo-400x91.webp" },
    { name: "SAS", logo: "/wp-content/uploads/2023/09/supporter_SAS_logo-400x164.webp" },
    { name: "VolunteerMatch", logo: "/wp-content/uploads/2023/09/supporter_SAS_logo-400x164.webp" },
    { name: "Zoom", logo: "/wp-content/uploads/2023/09/supporter_zoom_logo-400x90.webp" },
    { name: "Atlassian", logo: "/wp-content/uploads/2023/09/supporter_Atlasian_logo-400x127.webp" },
    { name: "DocHub", logo: "/wp-content/uploads/2023/09/supporter_DocHub_logo-400x95.webp" },
    { name: "Sendy", logo: "/wp-content/uploads/2023/08/supporter_sendy-logo.webp" },
    { name: "UptimeRobot", logo: "/wp-content/uploads/2023/09/uptimerobot-logo-300x92-1.webp" },
    { name: "CoPort", logo: "/wp-content/uploads/2024/08/CoPort_Logo-1-400x400.png" },
  ];
        ...
        <div style={styles.containerWide}>
          <div className="howtohelp-aboutGrid" style={styles.aboutGrid}>
            ...
            <div style={styles.aboutImageContainer}>
              <img
                src="/wp-content/uploads/2023/09/how-to-help-large-image-1200x796.webp"
      ...
      <section style={styles.volunteerSection}>
        <div style={styles.container}>
          ...
          <div className="howtohelp-volunteerGrid" style={styles.volunteerGrid}>
            ...
            >
              <img
                src="/wp-content/uploads/2018/11/hhp-blueTM-2.png"
